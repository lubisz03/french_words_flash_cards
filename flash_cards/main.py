...
def main():
    ...
    def handle_new_word():
        ...
        window.after_cancel(words_obj.flip_timer)
        words_obj.new_word()
        ...
        words_obj.flip_timer = window.after(3000, eng_word)
    ...
    btn_restart = tkinter.Button(text="restart", highlightthickness=0,
                                 border=0, background=BACKGROUND_COLOR, command=restart_words)
